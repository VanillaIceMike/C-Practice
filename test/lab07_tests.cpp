...
// TEST_F(Lab07Fixture, balance_test){
//     test_numbers=std::vector<unsigned>({5,10,20,15,30,25,40,23,28});
//     for(unsigned i=0; i<test_numbers.size(); i++){
//         tree->insert(test_numbers[i]);
//     }
//     EXPECT_EQ(tree->height(), 6);
//     tree->balance();
//     EXPECT_EQ(tree->height(), 4);
//     test_numbers=std::vector<unsigned>({5,10,15,20,25,30,35,40,45,50,60,70,80,90,100});
//     for(unsigned i=0; i<test_numbers.size(); i++){
//         tree->insert(test_numbers[i]);
//     }
//     EXPECT_EQ(tree->height(), 10);
//     tree->balance();
